    ...
    <section className="py-[110px]" id="nosotros">
      <div className="container mx-auto px-margin-desktop">
        <div className="reveal max-w-[700px] mx-auto mb-14 text-center">
          <span className="eyebrow justify-center">Nosotros</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-[22px]">
          {members.map((member) => (
            <div
              key={member.name}
              className="reveal hover-lift bg-surface border border-line rounded-[22px] px-6 py-[34px] text-center"
            >
              <div className="w-[76px] h-[76px] mx-auto mb-[18px] rounded-full grid place-items-center font-display font-semibold text-2xl text-white bg-grad">
                {member.initials}
              </div>
